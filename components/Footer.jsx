...
export default function Footer() {
  return (
    <footer className=" bg-gradient-to-r from-[#3b83f6] to-[#06b6d4]">
      <div className="text-sm flex flex-col  items-center gap-10 md:flex-row md:items-start md:gap-3 justify-around text-gray-200 pt-6 pb-10 px-3 ">
      ...
      <div className=" border-gray-100 py-4 text-center text-xs text-gray-200">
